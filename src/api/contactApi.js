...
export const API_CONTACT = import.meta.env.VITE_API_CONTACT_URL;
export const API_DISPO = import.meta.env.VITE_API_DISPO_URL;
export const API_ADMIN = import.meta.env.VITE_API_ADMIN_URL;
export const API_RDV = import.meta.env.VITE_API_RDV_URL;
export const API_CONTACT_GET = import.meta.env.VITE_API_CONTACT_GET;
export const API_CONTACT_POST = import.meta.env.VITE_API_CONTACT_POST;
...
export const deleteContact = async (id) => {
  const res = await fetch(`${API_ADMIN}/contact/delete/${id}`, {
    method: "DELETE",
    credentials: "include",
  });
...
export const markContactAsRead = async (id) => {
  try {
    const res = await fetch(`${API_ADMIN}/contact/read/${id}`, {
      method: "POST",
      credentials: "include",
    });
